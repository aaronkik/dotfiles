---
name: create-conventional-commits
description: Create git commit(s) using conventional commits
...
The description MUST be in present tense and should be around 50 characters summarising the change. DO NOT go over 72
characters.
