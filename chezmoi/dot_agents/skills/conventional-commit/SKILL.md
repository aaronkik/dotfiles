...
Write commit messages terse and exact. Conventional Commits format. No fluff. Why over what. The British English
language can only be used. If changes can be split into multiple commits without breaking the code, do this.

Once the commit(s) have been created, ask if I would like to push to the remote repository.
...
- No trailing period
- Match project convention for capitalisation after the colon
